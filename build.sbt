...
val gh = GitHubSettings(org = "lukajcb", proj = "cats-mtl-special", publishOrg = "org.typelevel", license = apache2)
...
lazy val catsMtlDependency = Seq(
  libraryDependencies += "org.typelevel" %%% "cats-mtl-core" % catsMtlVersion)


lazy val catsMtlLawsDependency = Seq(
  libraryDependencies += "org.typelevel" %%% "cats-mtl-laws" % catsMtlVersion)
...
lazy val testsM   = module("tests", CrossType.Pure)
  ...
  .settings(catsMtlLawsDependency)
